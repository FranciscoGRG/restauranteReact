...
import { ObtenerPelisId } from '../js/script';
    ...
    return (
        <>
            <div className="flex justify-center">
                <div className="mt-16 bg-white p-8 rounded-lg w-[60%] shadow-md shadow-white" >
                    <h1 className="flex items-center justify-center text-4xl mb-10 text-black">Completa tu compra de: {NombrePeli.title}</h1>

                    <form className="max-w-md mx-auto">
                        <div className="relative z-0 w-full mb-5 group">
                            <input type="email" name="floating_email" id="floating_email" className="block py-2.5 px-0 w-full text-black text-sm  bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                        ...
                        <div className="grid md:grid-cols-2 md:gap-6">
                            <div className="relative z-0 w-full mb-5 group">
                                <select id="countries" className="bg-transparent  border border-transparent text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    <option selected>Choose a country</option>
                                    <option value="US">12:00</option>
                                    <option value="CA">13:30</option>
                                    <option value="FR">17:00</option>
                                    <option value="DE">19:00</option>
                                    <option value="DE">21:30</option>
                                </select>
